  ...
  return (
    ...
    style={{ backgroundImage: "url('https://images.unsplash.com/photo-1651352076676-58a34812f3d2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}>
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="md:flex justify-evenly items-center max-md:flex-col md:items-center py-20">
          ...
          <div data-aos="fade-zoom-in"
            ...
            <div className="md:w-32 lg:w-48 space-y-5">
              <div className="flex items-center text-white font-bold">{`0${activeIndex + 1}`}
                <div className="ml-2 h-0.5 w-7 bg-pink-700 "></div>
              </div>
              <div className="flex items-center text-white font-bold">{`0${activeIndex + 1}`}
                <div className="ml-2 h-0.5 w-7 bg-pink-700 "></div>
              </div>
            ...
            <div className="w-full md:w-2/3 lg:w-1/2">
              ...
              <div className="flex space-x-4">
                <div data-aos="flip-left"
                  ...
                  className={'bg-pink-700 hover:bg-transparent text-white font-semibold hover:text-white py-3 px-4 border border-pink-700 hover:border-pink rounded'} />
                </div>
                ...
                >
                  <Button lable={"Explore More"}   
                  className={'hover:transparent text-white font-semibold hover:text-pink-700 py-3 px-4 border border-white-500 hover:border-pink-700 rounded'} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div data-aos="fade-left" className="w-full md:w-2/3 lg:w-1/2 mt-8 md:mt-0">
            <div className="flex">
              <div className="py-10 w-full md:w-2/3 lg:w-1/2">
              ...
              <div className="text-white text-1xl space-y-4 pt-[50px] ml-5">
                ...
                <div className="flex ml-2 h-7 w-0.5 bg-pink-700"></div>
              </div>
            </div>
          </div>
