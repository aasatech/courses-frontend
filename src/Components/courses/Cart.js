    ...
    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <Image
          width={200}
          height={200}
          className="rounded-t-lg pb-5 w-full"
          src={`https://course-web-service.onrender.com` + course.image}
          alt="product image"
        />
      </a>
      <div className="flex pl-5 gap-2 ">
        <div className="bg-pink-300 rounded-md px-2 py-1">
          <h3 className="text-red-500">Design</h3>
        </div>
        <div className=" flex gap-2  items-center">
          <FontAwesomeIcon color="grey" width={20} height={20} icon={faClock} />
          <span>4 hours</span>
        </div>
      </div>
      <div class="px-5 p-5">
