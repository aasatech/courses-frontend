...
const Rating = () => {
  return (
    <div className="border-2 py-5 rounded-xl divide-y-reverse">
      <div className="lg:grid block grid-cols-3 gap-5 ">
        ...
        <div className="col-span-2 mx-5">
          <div className="flex items-center  ">
            <svg
              class="w-4 h-4 text-white stroke-yellow-300"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 22 20"
            ...
            <div className="w-9/12 h-2 mx-4 bg-gray-200 rounded stroke">
              <div
      ...
      <div className="lg:grid block grid-cols-3 gap-5">
        <div className="flex justify-center">
          <div>
            <div className="rounded-full w-20 h-20 bg-blue-500"></div>
            <div className="text-xs text-center mt-2">5 months ago</div>
          </div>
        </div>
        <div className="col-span-2 mx-5">
          ...
          <div className="text-xs leading-loose">
            ...
            there are some very <br /> valuable workout tips. <br />
            Great job!
          </div>
        </div>
      </div>
      ...
      <div className="lg:grid block grid-cols-3 gap-5">
        <div className="flex justify-center">
          <div className="flex items-center">
            <div className="text-xs text-center mt-2 ">5 years ago</div>
          </div>
        </div>
        <div className="col-span-2 mx-5">
          <div class="flex items-center mb-3">
            ...
            <svg
              class="w-4 h-4 text-white ms-1 stroke-yellow-300"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 22 20"
